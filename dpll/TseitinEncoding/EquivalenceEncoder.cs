...
{
    internal class EquivalenceEncoder : IDimacsEncoder
    {
        public EncodingResult VisitAnd(EncodingResult left, EncodingResult right)
        {
            ...
            {
                new CnfLiteral(true, c),  new CnfLiteral(false, a), new CnfLiteral(false, b)
            }));
            formula.Clauses.Add(new CnfClause(new List<CnfLiteral>()
            {
        ...
        public EncodingResult VisitNot(EncodingResult input)
        {
            ...
            formula.Clauses.Add(new CnfClause(new List<CnfLiteral>()
            {
                new CnfLiteral(true, c),  new CnfLiteral(true, a)
            }));
        ...
        public EncodingResult VisitOr(EncodingResult left, EncodingResult right)
        {
            ...
            formula.Clauses.Add(new CnfClause(new List<CnfLiteral>()
            {
                new CnfLiteral(true, c),  new CnfLiteral(false, a)
            }));
            formula.Clauses.Add(new CnfClause(new List<CnfLiteral>()
            {
                new CnfLiteral(true, c),  new CnfLiteral(false, b)
            }));
